...
1. Download ARM64 Talos Oracle image from https://omni.laskonet.com and place in /home/ken/
...
9. Set Oracle public IP address on [Unifi port forwarding](https://unifi.laskonet.com/network/default/settings/security/port-forwarding)
