...
Since this site doesn't have any authentication and exposes extremely sensitive information, I've made it only available via a workload proxy through https://omni.laskonet.com. Navigate to the `Home` cluster and click on the `Sealed Secrets` option under `Exposed Services`.